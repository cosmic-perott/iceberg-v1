...
root_agent = LlmAgent(
    model='gemini-2.5-flash',
    name='Manager_Agent',
    description='Lead orchestration travel agent that coordinates team sub-agents to synthesize comprehensive database and open-web travel reports.', # FIXED: Had duplicate food description
